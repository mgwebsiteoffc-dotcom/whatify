...
Route::prefix('/')->name('website.')->group(function () {
    ...
    Route::get('/partner', [\App\Http\Controllers\Website\PartnerPageController::class, 'index'])->name('website.partner');
Route::post('/partner/apply', [\App\Http\Controllers\Website\PartnerPageController::class, 'apply'])->name('website.partner.apply');
...
// =============================================
// ONBOARDING (auth but skip onboarding check)
// =============================================
...
// =============================================
// SUPER ADMIN ROUTES (checked FIRST)
// =============================================
...
// =============================================
// PAYMENT (auth, no CSRF issue with razorpay)
// =============================================
...
// =============================================
// AUTHENTICATED ROUTES (business owner + agent)
// =============================================
Route::middleware(['auth', 'onboarding'])->group(function () {

    // Dashboard (role-based redirect inside controller)
    ...
    Route::middleware(['subscription'])->group(function () {
        Route::get('/whatsapp/accounts/embedded-signup', [\App\Http\Controllers\WhatsappAccountController::class, 'embeddedSignup'])->name('whatsapp.accounts.embeddedSignup');
Route::post('/whatsapp/accounts/embedded-signup/callback', [\App\Http\Controllers\WhatsappAccountController::class, 'embeddedSignupCallback'])->name('whatsapp.accounts.embeddedSignupCallback');
